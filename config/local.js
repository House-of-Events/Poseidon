export default {
  ...
  SQS_FIXTURES_DAILY_QUEUE_URL:
    process.env.SQS_FIXTURES_DAILY_QUEUE_URL ||
    'http://localhost:4566/000000000000/fixtures-daily-queue',
  ...
  S3_BUCKET_NAME:
    process.env.S3_BUCKET_NAME || 'dev-fixtures-daily-details-bucket',
