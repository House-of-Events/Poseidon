...
async function testEmailService() {
    ...
    try {
        ...
        const result = await emailService.sendFixtureEmail(sampleUsers[0], sampleFixtureData);
        console.log('Single email result:', result);
        
        // Test bulk emails
        console.log('\n2. Testing bulk emails...');
        const bulkResult = await emailService.sendBulkFixtureEmails(sampleUsers, sampleFixtureData);
